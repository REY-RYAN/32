...
if(isNaN(user)) {
  ...
  .setTitle('Potsy')
  .addField(`İnfaz Edilen birileri var`, `**Yasaklayan :** <@${message.author.id}> \n **Yasaklanan :** ${qwe}\n **Yasaklama Nedeni :** ${sebep} `)
