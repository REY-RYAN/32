...
exports.run = async (client, message, args) => {
  ...
  if (args[0]) {
    ...
    if(!sebep) {
      let emqe = new Discord.RichEmbed()
      .setDescription('** Başarı ile nedensiz bir şekilde Uyku moduna geçildi.**')
      message.channel.send(emqe)
      }
    
    let qwe = new Discord.RichEmbed()
    .setDescription(`**Başarı ile ${a} nedeniyle. Uyku moduna geçildi** `)
    message.channel.send(qwe);
